---
title: "stock market fluctuation"
format: html
---

description:
This section contains some extra work Phoebe did for fun. 
\r\n
source:
https://www.kaggle.com/datasets/zongaobian/netflix-stock-data-and-key-affiliated-companies?resource=download
\r\n
https://www.kaggle.com/datasets/kirolosatef/netflex-stock-dataset-with-twitter-sentiment?select=Ntweets.xlsx
\r\n
```{r}
library(tidymodels)
library(readr)
